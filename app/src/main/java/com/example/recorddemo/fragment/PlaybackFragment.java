package com.example.recorddemo.fragment;
...
public class PlaybackFragment extends DialogFragment {
    ...
    private void startPlaying() {
        mPlayButton.setImageResource(R.drawable.icon_record_pause);
    ...
    private void pausePlaying() {
        mPlayButton.setImageResource(R.drawable.icon_record_play);
        mHandler.removeCallbacks(mRunnable);
        mMediaPlayer.pause();
    }
